...
export default function LoginBackground({
  ...
  return (
    ...
    >
      {/* === GitHub-style aurora layer (bottom-centre violet/pink glow) === */}
      {/* Bottom horizon glow — saturated purple bloom rising from below */}
      <div
        className="absolute"
        style={{
          left: "50%",
          ...
          background:
            "radial-gradient(ellipse at center, rgba(168, 85, 247, 0.55) 0%, rgba(139, 92, 246, 0.35) 28%, rgba(99, 102, 241, 0.18) 55%, transparent 80%)",
          filter: "blur(40px)",
          animation: "avs-aurora-pulse 12s ease-in-out infinite",
        }}
      />
      {/* Bright violet core highlight */}
      <div
        className="absolute"
        style={{
          left: "50%",
          ...
          transform: "translateX(-50%)",
          background:
            "radial-gradient(ellipse at center, rgba(217, 70, 239, 0.45) 0%, rgba(168, 85, 247, 0.20) 40%, transparent 75%)",
          filter: "blur(60px)",
          animation: "avs-aurora-pulse 8s ease-in-out 1.5s infinite reverse",
        }}
      />
      {/* Top fade — keeps the upper third deep + dark like GitHub */}
      <div
        className="absolute inset-x-0 top-0 h-[55%]"
        style={{
          background:
            "linear-gradient(to bottom, rgba(2, 6, 23, 0.85) 0%, rgba(2, 6, 23, 0.4) 50%, transparent 100%)",
        }}
      />
